...
#lineas H y mol
lines_spectral = np.array([3934, 4045 , 4226, 4300,3970, 4102, 4341, 4861, 4471, 4541])
lines_spectral_names = ['Ca II', 'FeI', 'Ca I/II','G b',r'H$_{\epsilon}$', r'H$_{\delta}$', r'H$_{\gamma}$', r'H$_{\beta}$', 'HeI', 'HeII']

#lineas de magnesio para 5200 A: 5167, 5172, 5183
# lines_spectral = np.array([3934, 4045 , 4226, 4300,5167, 5172, 5183,3970, 4102, 4341, 4861, 4471, 4541])
# lines_spectral_names = ['Ca II', 'FeI', 'Ca I/II','G b','','Mg','',r'H$_{\epsilon}$', r'H$_{\delta}$', r'H$_{\gamma}$', r'H$_{\beta}$', 'HeI', 'HeII']
...
data=np.genfromtxt('C:/Users/Pablo/OneDrive - Universidad de La Laguna/Master/Cuatri1/AtmosferasEstelares/Entregables/Entregable1/starprob1.dat', dtype=float)
x=data[:,0]
y=data[:,1]
...
# K0V=np.genfromtxt('C:/Users/Pablo\OneDrive - Universidad de La Laguna/Master/Cuatri1/AtmosferasEstelares/Entregables/Entregable1/espectros_referencia/HD3651_K0V.dat')
# x_K0V=K0V[:,0]
# y_K0V=K0V[:,1]
# K0I=np.genfromtxt('C:/Users/Pablo\OneDrive - Universidad de La Laguna/Master/Cuatri1/AtmosferasEstelares/Entregables/Entregable1/espectros_referencia/HD12014_K0Ib.dat')
# x_K0I=K0I[:,0]
# y_K0I=K0I[:,1]
# K5V=np.genfromtxt('C:/Users/Pablo\OneDrive - Universidad de La Laguna/Master/Cuatri1/AtmosferasEstelares/Entregables/Entregable1/espectros_referencia\HD201091_K5V.dat')
# x_K5V=K5V[:,0]
# y_K5V=K5V[:,1]
# K4p5Ib=np.genfromtxt('C:/Users/Pablo\OneDrive - Universidad de La Laguna/Master/Cuatri1/AtmosferasEstelares/Entregables/Entregable1/espectros_referencia\HD219978_K4p5Ib.dat')
# x_K4p5Ib=K4p5Ib[:,0]
# y_K4p5Ib=K4p5Ib[:,1]


# #normalizado
plt.plot(x, normalized_spectrum, color="r", linestyle='-', label='Star 1')
# plt.plot(x_K0I,y_K0I, color='blue', ls='dotted', label='HD12014_K0Ib')
# plt.plot(x_K0V,y_K0V, color='blue', ls='dotted', label='HD12014_K0V')
# plt.plot(x_K4p5Ib,y_K4p5Ib, color='blue', ls='dotted', label='HD219978_K4p5Ib')
# plt.plot(x_K5V,y_K5V, color='blue', ls='dotted', label='HD201091_K5V')
for i in range(0, np.size(lines_spectral)): 
        plt.axvline(lines_spectral[i], 0, 1, color = 'dimgrey', alpha = 0.5)
        plt.text(lines_spectral[i] + 0.5, max(normalized_spectrum), lines_spectral_names[i], fontsize = 12) # Cambiar max() al comparar estrellas
plt.xlabel('$\lambda$ ($\t{\AA}$)')
