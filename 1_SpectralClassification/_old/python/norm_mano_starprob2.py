...
data=np.genfromtxt('C:/Users/alich/ULL/1master/Atmosferas_estelares/entregable1/starprob2.dat', dtype=float)
x=data[:,0]
y=data[:,1]
...
# plt.figure()
b0v=np.genfromtxt('tipo_b\ALS_18929_B0V.dat')
x_b0v=b0v[:,0]
y_b0v=b0v[:,1]
b5v=np.genfromtxt('tipo_b\HD3369_B5V.dat')
x_b5v=b5v[:,0]
y_b5v=b5v[:,1]
b5i=np.genfromtxt('tipo_b\HD13267_B5Ia.dat')
x_b5i=b5i[:,0]
y_b5i=b5i[:,1]
b0i=np.genfromtxt('tipo_b\HD150898_B0Ib.dat')
x_b0i=b0i[:,0]
y_b0i=b0i[:,1]


plt.plot(x,normalized_spectrum, color="magenta",ls='--', label='Star 2')
plt.plot(x_b0i,y_b0i,ls='dotted', label='HD150898_B0Ib')
...
plt.title('Star 2 vs HD150898_B0Ib')
